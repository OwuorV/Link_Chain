...
export default async function Vets() {
  ...
  if (!session) {
    console.log("no session found can't access the marketplace page");
    ...
    if (!products) {
      ...
      return (
        <main className="flex flex-col items-center mt-3 w-full px-4">
          ...
          <p className="text-[16px] text-center max-w-[600px] text-[#000] mb-5 mt-5">
            Currently, there are no products available in the marketplace.
      ...
      return (
        <main className="flex flex-col items-center mt-3 w-full px-4">
          <h1 className="text-3xl font-bold text-center text-[#0f0] mb-4">
            {/* Hi, {session.user.name} Welcome to The Market Place */}
          </h1>
          <div className="p">
            <p className="text-[16px] text-center max-w-[600px] text-[#000] mb-5 mt-5">
              ...
              ({ id, name, category, description, imageUrl, price }) => (
                ...
                >
                  ...
                  <div className="relative flex flex-col p-4 text-left text-black w-full">
                    ...
                    <h2 className="text-xl font-semibold text-[#171821]">
                      {name}
                    </h2>
