import Card from "@/app/ui/dashboard/cardComponent";
...
export default function MainLayout() {
  return (
    <div className="flex flex-col w-full gap-10 mt-10 px-2 md:px-10">
      <div className="text-[32px] font-bold">Welcome to your Dashboard</div>
